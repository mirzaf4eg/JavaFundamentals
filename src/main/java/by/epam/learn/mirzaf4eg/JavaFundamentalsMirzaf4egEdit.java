...
import by.epam.learn.mirzaf4eg.MainTask.TaskFirst;
import by.epam.learn.mirzaf4eg.MainTask.TaskSecond;

public class JavaFundamentalsMirzaf4egEdit {
    public static void main(String[] args) {
        ...
        TaskFirst newUser = new TaskFirst();
        newUser.enteringUserName();
        System.out.println("Hello, " + newUser + "! " + "Tell us your story.");

        System.out.println("\nThe second task: Отобразить в окне консоли аргументы командной строки в обратном порядке.");
        System.out.println("Please, " + newUser + ", " + "enter the arguments command line: ");
        TaskSecond reversArgumentCommandLine = new TaskSecond();
        System.out.println("Look in reverse!: " + reversArgumentCommandLine);
//// Задание третье
...
//        OptionalTaskFirst n = new OptionalTaskFirst();
//          n.SetNum();
//          n.GetLong();
